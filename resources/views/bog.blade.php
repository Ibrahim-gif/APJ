...
<head>
    <meta charset="UTF-8">
    <title>APJ | Board of Governors</title>
    <!--Style Starts-->
                        ...
                        <ul class="nav navbar-nav">
                            <li class="active">
                                ...
                                <ul class="dropdown-menu multi-level">
                                    ...
                                    <li class="active"><a href="bog">Board of Governors</a></li>
        ...
        <div class="content">
            ...
            <table class="table table-responsive table-bordered">
                ...
                <tr>
                    ...
                    <td>Mentor Director, APJadodara till the appointment of regular Director</td>
                </tr>
            </table>
        </div>
    </div>
