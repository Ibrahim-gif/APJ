...
<head>
    <meta charset="UTF-8">
    <title>APJ | Student's Corner</title>
    <!--Style Starts-->
...
<body>
    ...
    <div class="wrapper">
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li class="active">
                                    ...
                                    <ul class="dropdown-menu multi-level">
                                        ...
                                        <li class="active"><a href="student_corner">Student's Corner</a></li>
        ...
        <div class="contents-wrapper">
            ...
            <div class="content" >
                <h3 style="color:#0f6c6b"> <u>Student's Corner</u></h3>
                <style>
                .center {
                  text-align: center
